...
(function( $ ) {
	...
	$(document).ready(function(){
		...
		if ( $('.wp-block-gallery').length > 0 ) { 
			...
			$('img', $(".wp-block-gallery")).each(function () {
			    var src = $(this).attr('data-lazyimg');
				var caption = $(this).next('figcaption').text();
				
			    if ( src !== undefined && src !== "" ) {
					$(this).closest( '.blocks-gallery-item' ).attr('data-src', src);
			    } 
			    if ( caption !== undefined && caption !== "" ) {
			    	$(this).closest( '.blocks-gallery-item' ).attr('data-sub-html', caption);
			    } 
			});
